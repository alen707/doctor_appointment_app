...
import 'package:docter_appointment_app/View/home_screens/componets/docter_details_badge.dart';
import 'package:docter_appointment_app/View/home_screens/componets/docter_details_review.dart';
import 'package:docter_appointment_app/l10n/app_localizations.dart';
import 'package:flutter/material.dart';

class DocterDetails extends StatefulWidget {
  const DocterDetails({super.key});

  @override
  State<DocterDetails> createState() => _DocterDetailsState();
}

class _DocterDetailsState extends State<DocterDetails> {
 ...
 Future<void> loadDoctor() async {
  ...
  setState(() {
    docter = data;
      print("Doctor is null: ${docter == null}");
  print("Reviews length: ${docter?.data.reviews.length}");
    print("Doctor is null: ${docter == null}");
  print("Reviews length: ${docter?.data.reviews.length}");
    print("Doctor is null: ${docter == null}");
  print("Reviews length: ${docter?.data.reviews.length}");
      ...
      Stack(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    DocterDetailsBadge(
                      icon: AssetImage("assets/icon/docter_badge_pationts.png"),
                    ...
                    DocterDetailsBadge(
                      icon: AssetImage("assets/icon/docter_details_rating.png"),
                      data: docter?.data.rating.toString()??"",
                      title: AppLocalizations.of(context)!.rating,
                    ),
                    DocterDetailsBadge(
                      icon: AssetImage("assets/icon/docter_details_reviews.png"),
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {},
                      child: Text(AppLocalizations.of(context)!.seeall, style: TextStyle(fontSize: 14)),
                    ),
                  ],
                ),
        ...
        bottom: 50,
         ...
         right: 20,
          ...
          child: InputButton(inputText: AppLocalizations.of(context)!.bookappointment, nextpage: () {
            Navigator.push(context,
            MaterialPageRoute(builder: (context) => BookAppoinmentScreen(),)
            );
